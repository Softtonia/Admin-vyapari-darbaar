...
export default function App() {
  // Active View State ('trader-directory', 'buy-requirements', 'mandi-rates', 'market-overview', 'dashboard', 'design-system', or 'login')
  const [currentView, setCurrentView] = useState('trader-directory');
