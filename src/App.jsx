...
export default function App() {
  // Active View State ('buy-requirements', 'mandi-rates', 'market-overview', 'dashboard', 'design-system', or 'login')
  const [currentView, setCurrentView] = useState('buy-requirements');
